...
describe('AwsCompileLayers', () => {
  ...
  describe('#compileLayers()', () => {
    ...
    // TODO(RYAN): Move/refactor + enable this test.
    it.skip('should create a layer resource with a retention policy, has the same logical id when not modify', () => {
      awsCompileLayers.serverless.service.layers = {
        test: {
          path: 'layer',
          retain: true,
    ...
    // TODO(RYAN): Move/refactor this test.
